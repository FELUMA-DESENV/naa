package com.feluma.naa.dao.generic;
...
public abstract class GenericoDAO<T, ID extends Serializable> implements Serializable {
	...
	public List<T> listar(){
		...
		sb.append("select o from "); sb.append(getClasseDaEntidade().getSimpleName());
		sb.append(" o order by o.codigo desc");
		
		return manager.createQuery(sb.toString())
				.getResultList();
	}
