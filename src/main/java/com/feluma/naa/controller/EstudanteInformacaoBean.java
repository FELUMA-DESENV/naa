...
@Named
@ViewScoped
public class EstudanteInformacaoBean implements Serializable {
	...
	public EstudanteInformacaoBean() {
	...
	public void  salvar(){
		...
		FacesUtil.addInfoMessage("Informações complementares do estudante salvas com sucesso!");		
	}	
